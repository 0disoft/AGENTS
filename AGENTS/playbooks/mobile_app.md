# 모바일 앱 (Mobile App) 플레이북

모바일 애플리케이션 개발을 위한 표준 모듈화된 실행 과정입니다.
...
* [`api_design.md`](../modules/api_design.md): 프런트엔드(모바일 앱)와 백엔드를 연결할 API 명세와 계약을 설계합니다.
...
* [`local_storage_plan.md`](../modules/local_storage_plan.md): 클라이언트(모바일 기기) 저장소 사용 정책과 데이터 만료 전략을 정합니다.
...
* [`app_store_submission_plan.md`](../modules/app_store_submission_plan.md): 모바일 앱 마켓 제출 준비와 검수 대응 전략을 정리합니다.
...
* [`seo_and_promotion.md`](../modules/seo_and_promotion.md): 앱 스토어 최적화(ASO) 및 홍보 채널 활용 계획을 정리합니다.
